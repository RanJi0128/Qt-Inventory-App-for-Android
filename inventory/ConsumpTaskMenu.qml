...
//    height: 768
      ...
      {
         userId = key
         table_model.getReadAllData(key)
         _loader.reload()
        ...
        Page {
                ...
                Label {
                    ...
                    text: qsTr("Consumption Jobs/Units")
                ...
                MessageDialog {
                    ...
                    onAccepted: {
                        var pri_key = table_model.getData(_loader.item.rowNum,0)
                        if(table_model.deleteData(pri_key))
                        {
                ...
                RoundButton {
                    ...
                    onClicked: {
                        ...
                        _consumptaskcreate_page.userId = userId
                        _consumptaskcreate_page.edit_fl=true
                        _consumptaskcreate_page.rowNum = _loader.item.rowNum
                        _consumptaskcreate_page.visible = true
                ...
                RoundButton {
                    ...
                    onClicked: {
                        ...
                        _consumptaskcreate_page.userId = userId
                        _consumptaskcreate_page.edit_fl=false
                        _consumptaskcreate_page.visible = true
                        menutask_page.visible = false
        ...
        ConsumpCreateTask {
            ...
            onSignalExit:{
                ...
                editBt.enabled=false
                deleteBt.enabled=false
                _consumptaskcreate_page.visible = false
