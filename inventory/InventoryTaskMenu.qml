...
//    height: 768
      ...
      {
         userId = key
         inventoryTable_model.getReadAllData(key)
         _loader.reload()
     ...
     Page {
           ...
           height: parent.height
            ...
            Label {
                ...
                text: qsTr("Inventory Jobs/Units")
            ...
            MessageDialog {
                ...
                onAccepted: {
                    var pri_key = inventoryTable_model.getData(_loader.item.rowNum,0)
                    if(inventoryTable_model.deleteData(pri_key))
                    {
            ...
            RoundButton {
                ...
                onClicked: {
                    ...
                    _inventorytaskcreate_page.userId = userId
                    _inventorytaskcreate_page.edit_fl=true
                    _inventorytaskcreate_page.rowNum = _loader.item.rowNum
                    _inventorytaskcreate_page.visible = true
            ...
            RoundButton {
                ...
                onClicked: {
                    ...
                    _inventorytaskcreate_page.userId = userId
                    _inventorytaskcreate_page.edit_fl=false
                    _inventorytaskcreate_page.visible = true
                    menutask_page.visible = false
     ...
     InventoryCreateTask {
         ...
         onSignalExit:{
             ...
             _inventorytaskcreate_page.visible = false
